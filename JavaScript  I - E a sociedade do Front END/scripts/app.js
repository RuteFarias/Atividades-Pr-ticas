...
//* Tirar dúvida do prompt que concatena os valores ao invés de somar.
var num1 = 100;
var num2 = 50;
...
document.getElementById('cor').innerHTML = veiculo.cor;
document.getElementById('ano').innerHTML = veiculo.ano;
document.getElementById('valor').innerHTML = veiculo.valor;
document.getElementById('renavam').innerHTML = veiculo.renavam;
